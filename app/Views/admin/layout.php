...
<head>
  ...
  <!-- ========= Tabler Icon ========== -->
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/tabler-icons/3.23.0/tabler-icons.min.css" integrity="sha512-REsH3EWS6ul1Ab2qjlvH5XGZtgp8PJ8/qWoV8W7k+x1oZteI5gXxpxKSCr5AcSspPYWnqgKsZSeNKcA3lx02PA==" crossorigin="anonymous" referrerpolicy="no-referrer" />
      ...
      <ul>
        ...
        <li class="nav-item nav-item-has-children mb-2">
          ...
          <ul id="master-data" class="collapse dropdown-nav">
            ...
            <li>
              <a href="<?= base_url('admin/lokasi_presensi') ?>">Lokasi Persensi</a>
            </li>
          </ul>
        </li>
    ...
    $(function() {
      <?php if (session()->has('berhasil')) { ?>
        const Toast = Swal.mixin({
          ...
          didOpen: (toast) => {
            toast.onmousenter = Swal.stopTimer;
